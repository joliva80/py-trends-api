...
pytrend = TrendReq()
#pytrend.build_payload(kw_list=['energia solar'])
pytrend.build_payload(kw_list=['energia solar'],geo='ES') #, 'solar energy'])
...
'''
# Interest by Region
df = pytrend.interest_over_time() #.interest_by_region()
print(df.head(10))
